  ...
  implements vscode.CustomTextEditorProvider
{
  ...
  private addNewScratch(document: vscode.TextDocument) {
    ...
    const character =
    CloudFormation3DViewerProvider.scratchCharacters[
        Math.floor(
          Math.random() * CloudFormation3DViewerProvider.scratchCharacters.length
        )
      ];
    json.scratches = [
  ...
  public async getDocumentSymbols(uri: vscode.Uri) {
    ...
    try {
      // Execute the document symbol provider for the current document
